 ...
 */
final readonly class DigestCredential implements AuthorizationCredential
{
    /**
     ...
     * @param string|null $opaque optional server-provided opaque value
     * @param string|null $algorithm algorithm identifier, usually "MD5"
     */
